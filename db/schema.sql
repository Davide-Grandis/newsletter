...
--
--   day             : current warmup day (1-based, 1..WARMUP_DAYS); NULL until
--                     warmup starts (first time demand > 0 is observed).
--   day_started_at  : UTC 'YYYY-MM-DD' the current warmup day began. The day
--                     advances (demand > 0) once per calendar date change.
