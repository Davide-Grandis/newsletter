...
export default function SuperAdmins() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">Super admins</h2>
      ...
      <div className="bg-white border border-slate-200 rounded overflow-hidden dark:bg-slate-900 dark:border-slate-800">
        <table className="w-full text-sm">
          ...
          <tbody>
            {users.isLoading && (
              <tr><td colSpan={2} className="p-4 text-center text-slate-500 dark:text-slate-400">Loading…</td></tr>
            )}
            {supers.map((u) => (
            ...
            {users.data && supers.length === 0 && (
              <tr><td colSpan={2} className="p-4 text-center text-slate-500 dark:text-slate-400">No super admins.</td></tr>
            )}
          </tbody>
        </table>
      </div>
